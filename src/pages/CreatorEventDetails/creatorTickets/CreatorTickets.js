  ...
  return (
    <div className={classes.whole}>
      <div className={classes.container}>
        ...
        <GenericFilterTabs FilterTabsData={TicketsFilterTabs}/>
      <div>
     
            <div className={classes.btn}>
               <Button className={classes.button}  onClick={toggleDrawer('right', true)} data-testid="AddTicketButton" >Add Ticket</Button>
            </div>
            <SwipeableDrawer
                anchor={'right'}
                open={state['right']}
                ...
                PaperProps={{ style: { height: '1000px' , marginTop: 60,marginRight:20} }}
                ...
                <Box className={classes.box} sx={{ width: 407 }}>
                  ...
                  <div className={classes.forminfo}>
                      <div className={classes.typeofform}>
                        <div onClick={handlepaidclicked} className={paidclicked? classes.clickeditem: classes.item}>Paid</div>
                        <div onClick={handlefreeclicked} className={freeclicked?classes.clickeditem:classes.item}>Free</div>
                        <div onClick={handledonationclicked} className={donationclicked?classes.clickeditem:classes.item}>Donation</div>
                      </div>
                      <Formik
                          ...
                          <Form>
                            ...
                            <div className={classes.boxContainer}>
                              <div className={classes.fieldContainer}>
                                <label className={classes.label}>Available quantity</label>
                                <Field
                                  className={classes.field}
                            ...
                            <div className={classes.boxContainer}>
                              ...
                              <div className={classes.fieldContainer}>
                                ...
                                <label className={classes.label} style={{  paddingLeft: '20px' }} >Price</label>
                            ...
                            <div className={classes.boxContainer}>
                              <div className={classes.fieldContainer}>
                                <label className={classes.label}>When are tickets available?</label>
                                <Field
                                  className={classes.field}
                            ...
                            <div className={classes.containerstart}>
                                 ...
                                 <div className={classes.datacontainer}>
                                    <LocalizationProvider  dateAdapter={AdapterDayjs} >
                                      ...
                                      >
                                      <DemoItem>
                                        <DatePicker defaultValue={dayjs('2022-04-17')}sx={{ '& .MuiInputBase-input': { height: '17px',fontSize:13,paddingBottom:'18px',paddingTop:'18px' } }} />
                                      </DemoItem>
                                      </DemoContainer>
                            ...
                            <div className={classes.containerstart}>
                                 ...
                                 <div className={classes.datacontainer}>
                                    <LocalizationProvider  dateAdapter={AdapterDayjs} >
                                      ...
                                      >
                                      <DemoItem>
                                        <DatePicker defaultValue={dayjs('2022-04-17')}  sx={{ '& .MuiInputBase-input': { height: '17px',fontSize:13,paddingBottom:'18px',paddingTop:'18px' } ,     '& .MuiPickersCalendar-root': {fontSize: 14}}} />
                                      </DemoItem>
                                      </DemoContainer>
                                    </LocalizationProvider>
